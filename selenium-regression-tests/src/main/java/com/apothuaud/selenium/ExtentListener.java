...
public class ExtentListener implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            FileUtils.copyFile(src, new File("target/images/" + result.getMethod().getMethodName() + ".png"));
            String file = test.addScreenCapture("target/images/" + result.getMethod().getMethodName() + ".png");
